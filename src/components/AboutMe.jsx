    ...
    <section className="flex flex-col md:flex-row items-center justify-center px-6 py-16 bg-white text-[#064789]">
      ...
      <div className="w-full md:w-1/2 md:pl-12 text-center md:text-left">
        ...
        <p className="text-lg mb-4">
          I'm a full-stack developer with a strong focus on modern web and
          mobile technologies. I specialize in building smooth, responsive UIs
          and backend APIs, gateways for web apps and android applications.
        </p>
        <p className="text-lg mb-4">
          ...
          <strong>REST APIs</strong> to deliver real-time solutions.
        </p>
        <p className="text-lg mb-4">
          I'm also experienced with
          <strong>
            authentication systems like Clerk, Next auth, google auth...
          </strong>{" "}
          and flexible to integrate an authentication service of your choice,
          deployment, and connecting web apps to create full products — from
          admin dashboards to mobile apps.
        </p>
        <p className="text-lg">
