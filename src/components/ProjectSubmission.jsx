      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 text-center">
            <h3 className="text-2xl font-bold mb-2 text-[#064789]">
              Submissions Not Yet Open
            </h3>
            <p className="text-gray-700 mb-4">
              🚨 Project submissions will open from{" "}
              <strong>28th May 2025</strong> to <strong>4th June 2025</strong>.
              Please come back during this period to share your project.
            </p>
            <button
